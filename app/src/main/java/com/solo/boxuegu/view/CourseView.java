...
import com.solo.boxuegu.adapter.AdBannerAdapter;
import com.solo.boxuegu.adapter.CourseAdapter;
import com.solo.boxuegu.bean.CourseBean;
...
public class CourseView {
    ...
    private void getCourseData() {
        try {
			...
			cbl = AnalysisiUtils.getCourseInfos(is);//getCourseInfos(is)方法在下面会有说明
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
