...
import com.solo.boxuegu.adapter.ExercisesDetailAdapter;
...
public class ExercisesDetialActivity extends AppCompatActivity {
    ...
    private void initData() {
        try {
            ...
            InputStream is = getResources().getAssets().open(
                    "chapter" + id + ".xml");
            ebl = AnalysisiUtils.getExercisesInfos(is);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void init() {
        ...
        tv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ExercisesDetialActivity.this.finish();
            }
        });
        adapter = new ExercisesDetailAdapter(ExercisesDetialActivity.this,
                new ExercisesDetailAdapter.OnSelectListener() {
                    ...
                    public void onSelectD(int position, ImageView iv_a,
                        ...
                        AnalysisiUtils.setABCDEnable(false, iv_a, iv_b, iv_c, iv_d);
                    }
                    @Override
